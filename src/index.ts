 ...
 *
 * This plugin (language) only requires mount 2:
 *   - /cache (RW) - to cache language aggregation results
 *   - Note: This plugin aggregates metadata from ffmpeg, doesn't read files
 *
